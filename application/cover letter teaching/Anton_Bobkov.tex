...
\usepackage[lmargin=1in,rmargin=1in,tmargin=.75in,bmargin=0.75in]{geometry}
...
\coverletter
  ...
  % {a Mathematics Instructor position}
  {a Lecturer position}
  {\mathjobs}
  {}
  % {\teachliberalart}
  ...
  % {\publication, as well as a graduate transcript}
  % {\publication, as well as a teaching portfolio}
  % {\noresearch}
...
\coverletter
  ...
  {\genintro}
  % {a Visiting Assistant Professor position}
  {Lecture, Assistant Professor, Associate Professor, and Professor of Mathematics positions}
  % {a Mathematics Instructor position}
  {\mathjobs}
  {}
  % {\teachliberalart}
...
\coverletter
  ...
  % {\teachliberalart}
  {the Oberlin College}
  {\generic, as well as a graduate transcript and an undergraduate transcript}
  % {\generic}
  {\recommendation}
\end{document}
...
\coverletter
  {}
  {\genintro}
  {a temporary assistant professor position}
  {\mathjobs}
  {}
  {the University of Delaware}
  {the AMS cover sheet, and my curriculum vitae}
  {\recommendation}
\end{document}
...
\coverletter
  {}
  {\genintro}
  {an Instructor/Assistant Professor position}
  {\mathjobs}
  {}
...
\coverletter
  {}
  {\genintro}
  {the MathCEP 16 Postdoc position}
  {\mathjobs}
  {I am particularly excited applying to this position at the University of Minnesota as I feel that I am a good match. I am hoping to improve my teaching skills, work with students at all levels of math (including K-12), and to exchange techniques with the other educators. I also have experience supervising undergraduate projects and I am looking forward to expand on that working with the University of Minnesota's undergraduates.\joint}
...
\coverletter
  {}
  {\genintro}
  {a Visiting Assistant Professor of Mathematics Position}
  {\mathjobs}
  {\teachliberalart\joint}
...
\coverletter
  {}
  {\genintro}
  {an Assistant Professor, Teaching Stream position}
  {\mathjobs}
  % {\teachliberalart\joint}
  {}
  {the University of Toronto}
  {\noresearch, as well as a teaching portfolio that includes teaching evaluations}
  {\recommendation}
\end{document}
