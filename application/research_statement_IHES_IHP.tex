...
\subsection*{Short Project Description for IHES-IHP Postdoc}
The rest of my work deals with p-adic numbers and valued fields.
...
I have also shown that a Henselian valued field of equi-characteristic zero has linear one-dimensional VC-density if its value group and its residue field have that property. This is along the lines of the results of Ax-Kochen mentioned before.
My research goal is to adapt those techniques to higher dimensions, as well as applying them to RV sorts introduced by Flenner in 2011 \cite{value}.
