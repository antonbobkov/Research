...
\begin{Definition}
Given a tree $T$ of finite height and $n \leq m$ with $n \in \N, m \in \N \cup \{\infty\}$. Define $T \midr [n,m]$ to be the subtree of $T$ obtained only by considering nodes at depth $d$, with $n \leq d \leq m$. Call $T \midr [n, \infty]$ the $n$-slice of $T$.
\end{Definition}
