...
\begin{Lemma}
	Suppose $T$ is almost finite. Then all the connected components have different theories.
\end{Lemma}

\begin{Proof}
	Consider a node $t \in T$. All the cones under $t$ has different theories by induction, and there are finitely many of them by assumption that $T$ is almost finite.
\end{Proof}
