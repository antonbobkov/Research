...
\begin{Lemma} \label{lm_meet}
	Suppose $S \subseteq T$ is a finite subset of size $n$ in a meet tree and $S'$ its closure under meets. Then $|S'| \leq 2n$.
\end{Lemma}
\begin{proof}
...
\bibitem{laskowski}
  ...
  Israel J. Math. 161 (2007), 157–186. MR MR2350161	
\end{thebibliography}
