...
\begin{proof}
	Two applications of previous lemma.
\end{proof}

We specialize previous lemma to finite complexity types using compactness.

\begin{Corollary}
	For every $n$ there exists $m = m(n)$ such that if $a,b \in (c_1, c_2)$ s.t. $a \equiv^m_{c_1c_2} b$
\end{Corollary}
