...
Suppose it defines a minimal chain extension $\{M_i\}$ over $\{x, y\}$. 
...
Suppose $M$ is some arbitrary set and $(M_i, a_i b)$ is some chain-minimal extension with total dimension $\epsilon_U$ and size $K$. %??
Then we claim
\begin{Claim}
	\begin{align*}
...
\begin{Lemma}
	\begin{align*}
		...
		|\partial(\bar M_i, (A \cup b))| &\leq m_i \cdot K \\
		|\bar M_j - (A \cup b)| &\leq m_i \cdot K
	\end{align*}
\end{Lemma}
