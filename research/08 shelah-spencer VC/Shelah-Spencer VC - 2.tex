...
Inductively estimate $\dim(\bar M_j / A) < j \epsilon_U$

Apply lemma to $\bar M_j \cup \{a_j\}$ and $M_j / \{a_j, b\}$.
There are two cases
\begin{enumerate}
...
We have $\bar M = \bigcup (\bar M_j - M_j)$ a disjoint union.
$\bar M / \bar A$ is the sum of all the extra dimensions
