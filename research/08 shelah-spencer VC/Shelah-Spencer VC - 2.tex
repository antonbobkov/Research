...
\begin{Definition}
	...
	\begin{itemize}
		...
		\item Call $f \colon G_1 \arr G_2$ a $\delta$-isomorphism if it is a graph isomorphism and it is constant on $\bar A$.
		$\II_b$ is the $\delta$-isomorphism class of the graph induced on vertices $(\bar M_b - \bar A) \cup \partial_b$.
	\end{itemize}
\end{Definition}
