...
\begin{Theorem} \label{main_bound}
	\begin{align*}
		|I_b| &\leq K(\phi) \frac{Y}{\epsilon_\phi}\\
		|\partial_b| &\leq K(\phi) \frac{Y}{\epsilon_\phi}
	\end{align*}
\end{Theorem}

\begin{Corollary}
	\begin{align*}
		\vc(\phi) \leq K(\phi) \frac{Y}{\epsilon_\phi}
	\end{align*}
\end{Corollary}

\begin{proof}
		Let $W = K(\phi) \frac{Y}{\epsilon_\phi}$.
...
Formula with the largest quantity $\frac{K(\phi)}{\epsilon_\phi}$ contributes the most to the vc-density.
Thus we have
\begin{align*}
	\Phi &= \{\phi_i\}_{i \in I} \\
