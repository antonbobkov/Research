...
For our proof to work we also need $A$ to be $n$-strong for sufficiently large $n$.
...
To bound an arbitrary formula, write it as a boolean combination of basic formulas $\phi_i$.
It suffices to bound vc-density for collection of formulas $\{\phi_i\}_{i \in I}$ to obtain a bound for the original formula.
