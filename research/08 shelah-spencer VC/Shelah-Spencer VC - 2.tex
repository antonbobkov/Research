...
\begin{Definition}
	...
	\begin{itemize}
		...
		\item We also require that all elements of $y$ that are connected to $M_k - \{x,y\}$.
	\end{itemize}
\end{Definition}
...
We work with formulas that are positive boolean combinations of basic formulas written in disjunctive-conjunctive form.
