...
For simplicity we assume that for all basic formulas in our collection all elements of $y$ that are connected to $M_k - \{x,y\}$. (see note \ref{note_special})
...
\begin{Corollary}
	\begin{align*}
		\vc(\phi) \leq K_\phi \frac{Y}{\epsilon_\phi}
	\end{align*}
\end{Corollary}
...
Formula with the largest quantity $\frac{K_\phi}{\epsilon_\phi}$ contributes the most to the vc-density.
Thus we have
\begin{align*}
	\Phi &= \{\phi_i\}_{i \in I} \\
	\vc(\Phi) &= Y \max_{i \in I} \frac{K_{\phi_i}}{\epsilon_{\phi_i}}
\end{align*}
