...
\begin{Lemma}
	Let $\A_1 \subset \B_1$ and $\A_2 \subset \B_2$ be $\K$ structures with $\A_1$ and $\A_2$ disjoint. Also assume $(\A_2, \B_2)$ is a minimal pair and $B_2 \notin \B_1$. Let $\A = \A_1 \cup \A_2$ and $\B = \B_1 \cup \B_2$. Then $\delta(\B/\A)$ is minimized when $\B_2$ is disjoint from $\B_1$.
\end{Lemma}
