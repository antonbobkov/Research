...
\begin{align*}
	\delta(\B/\A) \leq \delta(\B_1 \cup \A/\A) + \delta\left((\B_2 \cup \A)/((\B_1 \cap \B_2) \cup \A)\right)
\end{align*}
Thus all we need to do is to verify that $\delta\left((\B_2 \cup \A)/((\B_1 \cap \B_2) \cup \A)\right) \leq \delta (\B_2/\A_2)$. It is easy to show that this construction induces a proper subpair in $(\A_2, \B_2)$ which has to have smaller dimension.
