...
\end{align*}
Let $\B'$ denote graph induced on all the vertices in $f(\B_2)$ that are not in $\B_1 \cup \A_2$. Then $\delta (\B^*/A_2)$ has to be less than $\delta (\B_2/\A_2)$ by minimality of $(\B_2, \A_2)$. Relative dimension of the whole construction has to be even smaller.
