...
\begin{Lemma}
	Let $\A_1 \subset \B_1$ and $\A_2 \subset \B_2$ be $\K$ structures with $\A_1$ and $\A_2$ disjoint. Also assume $(\A_2, \B_2)$ is a minimal pair. Let $\A = \A_1 \cup \A_2$ and $\B = \B_1 \cup \B_2$
\end{Lemma}
