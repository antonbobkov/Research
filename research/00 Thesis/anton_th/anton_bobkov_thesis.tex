...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            \abstract       {
  Aschenbrenner et. al. have studied vc-density in the model-theoretic context.
  We investigate it further by computing it in some common structures: trees, Shelah-Spencer graphs, and an additive reduct of $p$-adic numbers.
  ...
  Following results of Podewski and Ziegler we show that flat graphs are dp-minimal.
}
...
\include{Trees_vc_density_}
\include{shelah_spencer_}
\include{QP_reduct_} 
\include{flat}
