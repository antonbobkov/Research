...
\begin{proof}
	$(\Rightarrow)$ Fix $\B \subset \M$ witnessing existential statement. By remark 5.3 and lemma 3.8 there is a unique $\B^* \in X_m$ maximally embeddable into $\M$ over $\B$ (with unique image). By lemma \ref{C} $\B^* \in Y(\B, \Phi, \Gamma, m)$.
