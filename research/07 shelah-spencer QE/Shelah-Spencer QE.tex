...
\begin{proof}
	$(\Rightarrow)$ Fix $\B \subset \M$ witnessing existential statement. By remark 5.3 and lemma 3.8 There is a unique $\B^* \in X_m$ (uniquely embedded) maximally embeddable into $\M$ over $\B$.
\end{proof}
