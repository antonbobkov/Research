...
%% Any formula $\phi(x, t)$  with $t$  singleton decomposes as the union of the following cells:

%% \begin{align*}
%%   \curly{(x, t) \in K \times D \mid \val a_1(x) \square_1 \val (t - c(x)) \square_2 \val a_2(x), t - c(x) \in \lambda Q_{n',m'} }
%% \end{align*}
