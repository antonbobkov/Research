...
With this tree we associate open balls $(t_1, \val(t_1 - t_2))$ for all $t_1, t_2 \in T$.
An interval is two balls $(t_1, v_1) \supset (t_2, v_2)$ with no balls in between.
An element $a \in \Q_p$ belongs to this interval if $a \in (t_1, v_1) - (t_2, v_2)$.
There are at most $2|T|$ different intervals.
...
\begin{Definition}
	...
	We have
	\begin{align*}
		|\Bt| = N_\theta + \prod_{i \in I} \paren{\text {number of cosets of $Q_i$}}
	\end{align*}
