...
Flat graphs in model theoretic context were first introduced in \bibitem{stable_graphs} as a natural class of stable graphs.
...
Superflat graphs are the graphs that for every $m \in \N$ there is $n \in \N$ such that avoid $K^m_n$ is avoided, where $K^m_n$ is $m$-subdvision of complete graph on $n$ vertices. Equivalent characterization given in \bibitem{stable_graphs}, Theorem 2
...
But this is exactly what it means to be dp-minimal, as given, say, in \bibitem{simon_dp_minimal} Lemma 1.4.4
