...
\begin{proof}
	By a flatness result we can find an infinite $\J \subset \I$ and a finite set $B'$ such that each pair from $J = (a_i : i \in \J)$ have distance $>n$ over $B'$. Using total indiscernibility we have an automorphism sending $J$ to $I$. Image of $B'$ under this automorphism is the required set $B$.
\end{proof}
