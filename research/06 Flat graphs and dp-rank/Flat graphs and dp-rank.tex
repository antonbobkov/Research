...
In other words, $B$ disconnects $P(\{a_i\})$. This shows that $\{a_i\}$ has finite connectivity in $P(\{a_i\})$. Applying lemma from last section we obtain

\begin{Lemma}
	Connectivity hull of $\{a_i\}$ in $P(\{a_i\})$ is finite.
\end{Lemma}
