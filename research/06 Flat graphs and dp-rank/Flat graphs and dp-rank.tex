...
In other words, $B$ disconnects $P_n((a_i)_{i \in I})$. This shows that $(a_i)_{i \in I}$ has finite connectivity in $P((a_i)_{i \in I})$. Applying Corollary {cr_hull_finite} we obtain that connectivity hull of $\{a_i\}$ in $P_n(\{a_i\})$ is finite.
