...
\begin{Definition}
	...
	\begin{enumerate}
		\item $a,b \in V(G)$ define $d_A(a,b)$ to be the \emph{distance} (length of the smallest path) in an induced subgraph of $G$ after removing vertices $A$.
...
Connectivity of graphs is well described by Megner's Theorem. Here is a simple modification of the result in \cite{infinite_megner} concerning generalization of Megner's Theorem to infinite graphs.
