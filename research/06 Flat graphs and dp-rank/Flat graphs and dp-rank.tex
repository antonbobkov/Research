...
\begin{Theorem}
	Suppose we have an indiscernible sequence over parameter set $A$ in a flat graph $(a_i)_{i \in I}$ with $I$ countable. Fix $n \in \N$. Then there exists a finite set $B$ such that $(a_i)$ is indiscernible over $A \cup B$ and $d_B(a_i) \geq n$.
\end{Theorem}
