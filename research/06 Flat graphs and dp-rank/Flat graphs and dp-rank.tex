...
\begin{proof}
	Fix set $P$ = {p_1, \ldots, p_m} of all unordered pairs from $V$. Every pair $p_i$ has connectivity $n_i \leq n + 1$ and by previous lemma has finitely many sets of $n_i$ points that disconnect it, denoted by $S_i$.
\end{proof}
