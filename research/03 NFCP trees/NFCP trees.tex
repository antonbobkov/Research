...
Another notion that we consider is uniform boundedness. A formula is $\phi(x,y)$ uniformly bounded if there is $N$ such that for all $b$, $\phi(x, b)$ has either infinitely many realizations or less that $N$ many.
