\NotesBy{Notes by John Lensmire}
\Week{ Week 2 }

\Day{ Monday 10-13-2014 }
...
\begin{definition} \label{d26}%==== Definition 2.6 ====
...
\begin{lemma} \label{l27} % ==== Lemma 2.7 ==== 
Suppose for all $a,b\in \mathbf{No}$ with $l(a)\oplus l(b) < \gamma$ we have defined $a\cdot b$ so that (\ref{d26}) holds, and for all $a,b,c,d\in \mathbf{No}$ with the natural sum of the lengths of each factor is $<\gamma$ $(*)$ holds, where
...
Case 3:  Suppose $c \not<_s d, d\not<_s c$. Then by Case 1 and 2, $P(a,b,c,c\wedge d)$ and $P(a,b,c\wedge d, d)$, so (transitivity of the last two variables) $P(a,b,c,d)$ as needed. This completes the proof of \ref{l27}. \qed
...
Therefore, both assumptions of Theorem \ref{cofinality_theorem} hold, giving us the uniformity property for multiplication as needed.

\begin{proposition} % ==== Proposition 2.9 ==== 
 \end{proposition}
...
\Day{ Friday 10-17-2014 }

\begin{definition} % ==== Definition of Inverses ==== 
...
\begin{theorem} % ==== Theorem 2.10 (Conway) ==== 
