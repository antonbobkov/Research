...
# $S$ is Noetherian.
# Every final segment of $S$ is finitely generated.
# $\mathcal{F}(S)$ has the ascending chain condition.
# Every infinite sequence in $S$ contains an increasing finite subsequence.
# Every infinite sequence in $S$ is good.
