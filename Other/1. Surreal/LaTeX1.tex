...
\begin{align*}
	...
	\left\{ \sum_{i < \alpha} f_i\w^{a_i} + (f_i - \epsilon) \w^{a_\alpha} \right|
	\left. \sum_{i < \alpha} f_i\w^{a_i} + (f_i + \epsilon) \w^{a_\alpha} \right\}
\end{align*}
...
\begin{align*}
	...
	&\curly{\sum_{i < \beta} f_i \w^{a_i} + (f_\beta - \epsilon) \mid
	\sum_{i < \beta} f_i \w^{a_i} + (f_\beta + \epsilon)}_{\beta < \alpha, \epsilon \in \R^{>0}}
\end{align*}
