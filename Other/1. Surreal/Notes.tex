...
By induction hypothesis easily shows that those cuts are cofinal (and are in fact final segments) in the cuts given in the original definition.
Pick any $\bar f(\w) \in R_f$ and $\bar g(\w) \in L_g$.
Then $\bar f(x) < \bar g(x)$ as first coefficient where they differ is $x^{a_\gamma}$
...
\begin{align*}
	f(\w) - g(\w) &= (f_\gamma - g_\gamma) x^{a_\gamma} + (f* - g*)
\end{align*}

We have $f_\gamma < g_\gamma$, so 
Also 
 we have $\bar f(x) < \bar g(x)$ and thus by induction hypothesis $\bar f(\w) < \bar g(\w)$. As choice of those was arbitrary we have $R_f < L_g$ so $f(\w) < g(\w)$.
